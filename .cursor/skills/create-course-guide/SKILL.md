...
始める前に、冠（`data/references/職場ドリル_呉服売場版.md` の「30秒で共有するなら」）とシリーズの `purpose` を引用する。学習の型は冠。このコースの仕事はシリーズ目的のどの部分かを聞く。
...
薄い回答は深掘りしてから次へ進む。各レッスンの仕事は標語ではなく、学習者がその回で身につける判断で書く。コース1レッスン3は所有の標語ではなく前提合わせである（固定認識を見る）。コース4以降は「代表を見分ける」を標語にせず、次の一言・提案の方向で書く。
